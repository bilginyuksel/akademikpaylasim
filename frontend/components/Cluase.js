            ...
            <Accordion.Collapse eventKey={clause.id}>
                <Card.Body>
                    <Table striped bordered hover>
                        ...
                        <tbody>
                            {
                                clause.subclausies.map(item=>(<Bent key={item.name} maxPoint={clause.maxPoint} parentName={clause.name} name={item.name} title={item.title} point={item.point} handler={handleShow} />
                                ))
                            }
                        </tbody>
                    </Table>
